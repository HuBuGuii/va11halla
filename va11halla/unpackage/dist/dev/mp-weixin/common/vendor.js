...
function initRuntimeSocketService() {
  const hosts = "192.168.136.216,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_E8aVLD";
...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "VA11-Hall-A"
    }
  },
  {
  ...
  {
    path: "pages/game/cowbay",
    style: {
      navigationBarTitleText: "cowboy"
    }
  },
  {
    path: "pages/chat/deepseek",
    style: {
      navigationBarTitleText: "deepseek",
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "ai聊天小助手"
    }
  }
];
const globalStyle = {
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","192.168.136.216"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","C:/hx/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"va11halla","spaceId":"mp-9aad41c1-5f10-47f1-8cb2-df81014d15d2","clientSecret":"rVT6rSyj+vyqs3h9TNFqAA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__E202499";
} catch (e2) {
...
var define_process_env_UNI_STAT_TITLE_JSON_default = { "pages/index/index": "VA11-Hall-A", "uni_modules/uni-id-pages/pages/register/register": "注册", "uni_modules/uni-id-pages/pages/login/login-withoutpwd": "登录", "uni_modules/uni-id-pages/pages/login/login-withpwd": "账号密码登录", "uni_modules/uni-id-pages/pages/login/login-smscode": "手机验证码登录", "uni_modules/uni-id-pages/pages/userinfo/userinfo": "个人资料", "uni_modules/uni-id-pages/pages/userinfo/bind-mobile/bind-mobile": "绑定手机号码", "uni_modules/uni-id-pages/pages/register/register-by-email": "邮箱验证码注册", "uni_modules/uni-id-pages/pages/retrieve/retrieve": "重置密码", "uni_modules/uni-id-pages/pages/retrieve/retrieve-by-email": "通过邮箱重置密码", "uni_modules/uni-id-pages/pages/userinfo/change_pwd/change_pwd": "修改密码", "uni_modules/uni-id-pages/pages/register/register-admin": "注册管理员账号", "uni_modules/uni-id-pages/pages/userinfo/set-pwd/set-pwd": "设置密码", "uni_modules/uni-id-pages/pages/userinfo/deactivate/deactivate": "注销账号", "uni_modules/uni-id-pages/pages/userinfo/realname-verify/realname-verify": "实名认证", "pages/game/cowbay": "cowboy", "pages/chat/deepseek": "deepseek", "pages/chat/index": "ai聊天小助手" };
    ...
    }
    {
      ...
      if (!index.__stat_uniCloud_space) {
        if (space && Object.keys(space).length !== 0) {
          ...
          index.__stat_uniCloud_space = nr.init(spaceData);
        } else {
