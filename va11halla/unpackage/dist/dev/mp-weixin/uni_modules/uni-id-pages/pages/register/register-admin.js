...
const uniIdCo = common_vendor.nr.importObject("uni-id-co", { customUI: true });
const _sfc_main = {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    t: common_vendor.sr("agreements", "3bae2854-9,3bae2854-0"),
    v: common_vendor.p({
      scope: "register"
    }),
    ...
    z: common_vendor.sr("form", "3bae2854-0"),
    A: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
